# The Daily Standup: Beyond Status Updates

*Guidance • For All Disciplines*

**Thesis**: Effective daily standups focus on collaboration and removing blockers, not just status reporting

**Keywords**: daily, standup, scrum, agile, meeting, status, blockers, team

**Coverage**: 6.5% average
**Sources**: 6 documents
**⚠️ Low Coverage**: 19 section(s)
...
❌ *Coverage: 0% from 4 document(s)*
*Note: ⚠️ Low corpus coverage (0%)*
...
❌ *Coverage: 14% from 3 document(s)*
*Note: ⚠️ Low corpus coverage (14%)*
...
❌ *Coverage: 10% from 4 document(s)*
*Note: ⚠️ Low corpus coverage (10%)*
...
❌ *Coverage: 4% from 7 document(s)*
*Note: ⚠️ Low corpus coverage (4%)*
...
❌ *Coverage: 3% from 6 document(s)*
*Note: ⚠️ Low corpus coverage (3%)*
...
❌ *Coverage: 2% from 8 document(s)*
*Note: ⚠️ Low corpus coverage (2%)*
...
❌ *Coverage: 9% from 3 document(s)*
*Note: ⚠️ Low corpus coverage (9%)*
...
❌ *Coverage: 19% from 3 document(s)*
*Note: ⚠️ Low corpus coverage (19%)*
...
❌ *Coverage: 21% from 4 document(s)*
*Note: ⚠️ Low corpus coverage (21%)*
...
❌ *Coverage: 5% from 5 document(s)*
*Note: ⚠️ Low corpus coverage (5%)*
...
❌ *Coverage: 8% from 4 document(s)*
*Note: ⚠️ Low corpus coverage (8%)*

### Evolution and Maintenance
Naming conventions should evolve with your organization. This subsection covers how to propose changes, version your naming guide, and communicate updates without breaking existing muscle memory.
❌ *Coverage: 19% from 3 document(s)*
*Note: ⚠️ Low corpus coverage (19%)*
